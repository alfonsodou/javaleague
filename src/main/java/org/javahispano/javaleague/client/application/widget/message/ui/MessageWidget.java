...
package org.javahispano.javaleague.client.application.widget.message.ui;

import javax.inject.Inject;

import org.javahispano.javaleague.client.application.widget.message.Message;
import org.javahispano.javaleague.client.application.widget.message.MessageCloseDelay;
...
public class MessageWidget extends Composite {
	...
	@Inject
	MessageWidget(Binder binder, AppResources appResources,
