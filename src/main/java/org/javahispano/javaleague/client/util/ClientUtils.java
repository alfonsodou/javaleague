...
{
    private final static String SESSION_ID_COOKIE         = "javaleague_session_id";
    private final static String AUTH_PROVIDER_COOKIE      = "javaleague_provider";
    private final static String AUTH_PROVIDER_NAME_COOKIE = "javaleague_provider_name";
    private final static String USERNAME_COOKIE           = "javaleague_user";
    private final static String REDIRECT_URL_COOKIE       = "javaleague_redirect_url";
